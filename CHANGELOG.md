...
- macOS first-success path: `brew tap gvkhosla/ytmd https://github.com/gvkhosla/ytmd` then `brew install ytmd`. Formula pins tag v0.7.0; `--HEAD` still tracks main. Agent skill remains a separate `install.sh --agent` step.
